...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    parser.add_option('-i','--input',dest='infile',default='./data/txt/NumberTwo.txt',help='zhwiki corpus')
    parser.add_option('-m','--outmodel',dest='wv_model',default='./data/txt/NumberTwo.model',help='word2vec model')
    parser.add_option('-v','--outvec',dest='wv_vectors',default='./data/txt/NumberTwo.vectors',help='word2vec vectors')
